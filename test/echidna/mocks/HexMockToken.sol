...
contract HexMockToken is ERC20, IHexToken {
    ...
    /// @notice mints HEX to the recipient
    function mint(address recipient, uint256 amount) external {
        _mint(recipient, amount);
    }

    /// @notice used to set a mock HEX / T-shares exchange rate
    function setShareRate(uint40 newShareRate) external {
        globalInfo.shareRate = newShareRate;
    }
